...
namespace EnumerableTask.Tests
{
    public class EnumerableManipulationTests
    {
        ...
        public class HiddenTest
        {
                ...
                {
                    {
                        ...
                        yield return new TestCaseData(new[] {"aaa", "bbbb", "ccc", null},
                            "b",
                            new[] {"bbbb"},
                            "Method should return items started with required prefix.");
                        yield return new TestCaseData(new[] {"aaa", "aaabbbb", "cccbbbb", null},
                            "b",
                            new string[] { },
                            "Method should return items started with required prefix.");
                        ...
                        yield return new TestCaseData(data.Concat(nulls),
                            "HORSE",
                            result,
            ...
            public void GetEvenItemsTests(IEnumerable<string> data, string prefix, IEnumerable<string> expected,
                string message)
            {
                var target = new EnumerableManipulation();
            ...
            public void GetEvenItems_IfPrefixIsNull_ThrowArgumentNullException() =>
                Assert.Throws<ArgumentNullException>(
                    () => new EnumerableManipulation().GetPrefixItems(new string[] { }, null),
